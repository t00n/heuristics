...
This figure shows the percentage improvement of VND compared to single neighbourhoods. The percentage improvement is defined as the quotient of the percentage deviation of the neighbourhood in the columns on the percentage deviation of the neighbourhood in the rows.
\begin{figure}[H]
	\centering
