...
In regard of the fact that the exchange neighbourhood reaches better results than the two VND we ran, we can suppose that a VND ordering beginning by the exchange neighbourhood would be the best.
